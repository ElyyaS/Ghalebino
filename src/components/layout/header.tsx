...
import { CartButton, MobileMenu, SearchBar, UserMenu } from "./header-actions";
...
export async function Header() {
  ...
  return (<header className="sticky top-0 z-40 border-b border-slate-200 bg-white/90 backdrop-blur"> <div className="mx-auto flex h-16 max-w-7xl items-center gap-2 px-4 sm:gap-3"> <MobileMenu categories={categories} user={headerUser} />
